  ...
  <div class="app-container calendar-list-container">
    ...
    <div :class="tableLoading">
      ...
      <div v-for="orders in list" :key="orders.id">
        ...
        <el-table :show-header="hideTableHeader" :key='tableKey2' :data="[orders]" element-loading-text="给我一点时间" border fit
                  style="width: 100%;"
                  :row-style="rowStyle1"
          ...
          <el-table-column align="left" label="商品" min-width="280">
            <template slot-scope="scope">
              <el-table :show-header="hideTableHeader" :key='tableKey2' :cell-style="cellStyle2" :data="scope.row.orders_items" element-loading-text="给我一点时间" fit style="width: 100%;border:none;margin-bottom:-2px;">
          ...
          <el-table-column min-width="100" align="center" label="订单金额/代收金额">
            <template slot-scope="scope">
              ...
              <span v-for="item in scope.row.orders_payment.orders_payment_items"
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="innerDialogFormVisible3" width="70%">
      <el-form :rules="innerRules3" ref="innerDataForm3" :model="innerTemp3" label-position="left" label-width="80px"
        ...
        <el-form-item label="物流名称" prop="orders_logistics_type.code">
          <el-select v-model="innerTemp3.logistics_type_id"
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-dropdown v-if="!logisticsDialogLoading" trigger="click" placement="top-end"split-button type="primary" @click="createInnerData3(0, 1)" @command="handleCommand">
          确认发货并打印订单
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="innerDialogFormVisible9" width="70%">
      <el-form ref="innerDataForm9" label-position="left" label-width="80px"
               style='width: 80%; margin-left:10%;'>
        <el-form-item label="物流名称" prop="orders_logistics_type.code">
          <el-select v-model="sum_logistics_type_id"
  ...
  export default {
    ...
    methods: {
      ...
      resetSumLogisticsNumber() {
        ...
        this.sum_logistics_type_code = this.logisticsTypeOptions[this.logisticsTypeOptions.findIndex(d => d.id === this.sum_logistics_type_id)].code
        this.sum_warehouse_extra_id = undefined
      ...
      resetLogisticsNumber() {
        this.productDeliverExtraOptions = []
        this.innerTemp3.logistics_type_code = this.logisticsTypeOptions[this.logisticsTypeOptions.findIndex(d => d.id === this.innerTemp3.logistics_type_id)].code
      ...
      handleInnerUpdate3(row) {
        ...
        if (row.orders_logistics !== null) {
          ...
          this.innerTemp3.logistics_type_code = row.orders_logistics.orders_logistics_type.code
        } else {
      ...
      async createInnerData3(empty, ifPrint) {
        ...
        try {
          ...
          if (logisticsNumberInfo !== null) {
            ...
            this.innerTemp3.dest_extra_code = logisticsNumberInfo.data.dest_extra_code
          }
          // 更新物流单号
